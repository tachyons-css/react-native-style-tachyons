...
_lodash2.default.forEach(what, function (_ref) {
    ...
    var whatShort = _ref2[0];
    var whatLong = _ref2[1];

    _lodash2.default.forEach(where, function (_ref3) {
        var _ref4 = _slicedToArray(_ref3, 2);

        var whereShort = _ref4[0];
        var whereLong = _ref4[1];

        _lodash2.default.forEach(REM_SCALE, function (scale, idx) {
            style["" + whatShort + whereShort + idx] = _defineProperty({}, "" + whatLong + whereLong, scale + "rem");
        });
    });
});

...
var NativeTachyons = {
    ...
    build: function build() {
        ...
        var REM_SCALED = [require("./styles/heights").default, require("./styles/spacing").default, require("./styles/typeScale").default, require("./styles/widths").default, require("./styles/borders").radii];
        ...
        if (!_lodash2.default.isUndefined(Dimensions)) {
            var _Dimensions$get = Dimensions.get('window');

            var height = _Dimensions$get.height;
            var width = _Dimensions$get.width;

            NativeTachyons.styles["h-100"] = { height: height };
            NativeTachyons.styles["w-100"] = { width: width };
        }

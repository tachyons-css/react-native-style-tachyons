    ...
    var newClass = function (_WrappedComponent) {
        ...
        _createClass(newClass, [{
            ...
            value: function _recursiveStyle(elementsTree) {
                ...
                if (_lodash2.default.isString(props.cls)) {
                    ...
                    for (var i = 0; i < splitted.length; i++) {
                        ...
                        if (cls.length > 0) {
                            ...
                            (0, _Preconditions.checkState)(!_lodash2.default.isUndefined(style), "style '" + cls + "' not found");
                ...
                if (_lodash2.default.isArray(props.children)) {

                    /* convert child array */
                    newChildren = [];
                    for (var _i = 0; _i < props.children.length; _i++) {
                        var c = props.children[_i];
                    ...
                    var _converted = this._recursiveStyle(_c);
                    if (_converted !== _c) {
                        translated = true;

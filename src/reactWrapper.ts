...
export class ReactWrapper {
    ...
    static configure(styles: any, options: any) {
        this.styles = styles;
     ...
     * 'style' definitions.
     */
    static wrap(componentOrFunction: any) {
    ...
    private static setStyles(props: any, clsPropName: any, typeScale: any) {
        const newProps: any = {};
    ...
    private static recursiveStyle(elementsTree: any) {
        /*
        ...
        if (_.isArray(newChildren)) {
            ...
            const converted = (...args: any[]) => this.recursiveStyle(originalChildrenFunction(...args));
            if (converted !== newChildren) {
                translated = true;
                newChildren = converted;
            }

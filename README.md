...
***NOTICE:*** *This has been renamed. The old module [`react-native-tachyons`](https://www.npmjs.com/package/react-native-tachyons) (without the `-style-`) has been deprecated.*
